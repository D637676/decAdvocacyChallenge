...
plt.title("Cars Fixed per Day by Shop ID and Boss Presence", fontsize=14)
plt.xlabel("Shop ID", fontsize=11)
plt.ylabel("Number of Cars Fixed", fontsize=11)
...
plt.legend(handles=legend_elements, title="Boss Presence", fontsize=9)
